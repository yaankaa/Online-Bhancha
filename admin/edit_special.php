   ...
   ?>
    <div class="main-content">
        ...
        <div class="row">
            ...
            <?php
                $sql="Select * from special where id=".$_GET['edit_id'];
                $sqlRun = mysqli_query($con,$sql);
                $data = mysqli_fetch_assoc($sqlRun);
            ?>
                <form action="special_process.php" method="post"  
                enctype="multipart/form-data">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style= "height: 10px;"><textarea autocomplete="off"  placeholder="" type="text" name="description" id="" rows=12 ><?= $data['description'];?> </textarea></td>
                        </tr>
                        <tr>
                            <td><label for="">Price</label></td>
                            <td ><textarea autocomplete="off"  placeholder="" type="text" name="price" id=""  ><?= $data['price'];?> </textarea></td>
                        </tr>
                        <tr>
